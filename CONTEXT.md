...
**Última sessão:** 2026-04-25 (debug pipeline criado, migration 020 aplicada)

---

## Próximo passo imediato

**PRIORIDADE 1:** Criar workflow n8n `configure-webhook` — tabela `ml_captura.webhooks_config` já existe (migration 020), falta o workflow que registra a instância Evolution API, cria endpoint receptor e persiste a config.

**PRIORIDADE 2:** Story 1.1 task 2.8 — teste multi-agente com identificador_externo desconhecido (deve gravar null).
...
- [ ] Workflow n8n `configure-webhook` — criar e importar (tabela pronta)
